/* ============================================================
   ...
   ★1問が長くなる。設問文が longStem（この資格は90字）を超えると共通エンジンが
...
window.CERT = {
  ...
  /* 設問文を長文体裁に切り替えるしきい値（文字数）。エンジンの既定は130字。
     SAPは実測で四択が最長66字、シナリオが最短96字とはっきり分かれているため、
     その間の90字にしてシナリオだけを長文体裁にする（CLAUDE.md 第43-2節）。 */
  longStem: 90,
